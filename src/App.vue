...
const { isDark, checkConnection, isConnected, fetchMatchHistory, hasAuth } = useApp()
...
// const { hasAuth } = storeToRefs(useConnectionStore())
...
const isAppReady = computed(() => isConnected.value !== undefined && hasAuth.value !== undefined)
</script>
