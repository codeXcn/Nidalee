  ...
  <div v-if="hasError" class="min-h-screen flex items-center justify-center bg-background">
    <div class="max-w-md w-full mx-auto p-6">
      <div class="text-center space-y-4">
        ...
        <!-- 错误详情（可展开） -->
        <div class="space-y-2">
          <button @click="showDetails = !showDetails" class="text-sm text-primary hover:underline">
        ...
        <div class="flex gap-3 justify-center">
          ...
          <Button variant="outline" @click="reportError"> 报告问题 </Button>

          <Button variant="ghost" @click="reset"> 重置应用 </Button>
        </div>
