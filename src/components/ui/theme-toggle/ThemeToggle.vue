<template>
  <div class="theme-toggle">
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" class="w-48 backdrop-blur-xl bg-popover/95 dark:bg-popover/90">
        <DropdownMenuItem @click="themeStore.setTheme('light')" class="cursor-pointer group">
        ...
        <DropdownMenuItem @click="themeStore.setTheme('dark')" class="cursor-pointer group">
        ...
        <DropdownMenuItem @click="themeStore.setTheme('auto')" class="cursor-pointer group">
        ...
        <DropdownMenuItem @click="openThemeSelector" class="cursor-pointer group">
    ...
    <Dialog v-model:open="showThemeSelector">
      <DialogContent class="max-w-md">
          ...
          <div class="grid grid-cols-1 gap-3">
            ...
            >
              <div class="flex items-center justify-between mb-3">
                <span class="font-medium group-hover:text-primary transition-colors">{{ preset.name }}</span>
                <Check v-if="themeStore.selectedPreset === key" class="size-4 text-primary animate-in zoom-in-50" />
              </div>
        ...
        <DialogFooter>
          ...
          <Button @click="closeThemeSelector">
            确定
          </Button>
        </DialogFooter>
      </DialogContent>
