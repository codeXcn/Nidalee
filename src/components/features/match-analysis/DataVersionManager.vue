<template>
  <Card class="p-4">
    ...
    <div class="space-y-4">
      ...
      <!-- 更新状态提示 -->
      <div v-if="shouldUpdateData" class="bg-amber-50 dark:bg-amber-950/30 rounded-lg p-3 border border-amber-200 dark:border-amber-800">
      ...
      <!-- 离线提示 -->
      <div v-if="!navigator.onLine" class="bg-red-50 dark:bg-red-950/30 rounded-lg p-3 border border-red-200 dark:border-red-800">
